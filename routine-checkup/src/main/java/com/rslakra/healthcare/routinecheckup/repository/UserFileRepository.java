 ...
 */
@Repository
public interface UserFileRepository extends CrudRepository<UserFileEntity, UUID> {

    Optional<UserFileEntity> findByOwnerAndOriginalFileName(UserEntity user, String fileName);
