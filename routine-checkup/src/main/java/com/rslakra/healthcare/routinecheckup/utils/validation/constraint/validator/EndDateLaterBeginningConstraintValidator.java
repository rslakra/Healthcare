 ...
 */
public class EndDateLaterBeginningConstraintValidator implements ConstraintValidator<EndDateLaterBeginning, Object> {
    ...
    private EndDateLaterBeginning getAnnotation(Object value) {
        ...
        EndDateLaterBeginning annotation = objectClass.getAnnotation(EndDateLaterBeginning.class);
        return annotation;
    }
